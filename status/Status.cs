...
namespace Neo.Plugins
{
    public class Status : Plugin, IPersistencePlugin
    {
        ...
        private static readonly UInt160 NoBugDAO = UInt160.Parse("0x54806765d451e2b0425072730d527d05fbfa9817");
        ...
        void IPersistencePlugin.OnPersist(NeoSystem system, Block block, DataCache snapshot, IReadOnlyList<Blockchain.ApplicationExecuted> applicationExecutedList)
        {
            ...
            ApplicationEngine balanceOfNoBugDAO = ApplicationEngine.Run(BNEO.MakeScript("balanceOf", new object[] { NoBugDAO }), snapshot, settings: system.Settings);
